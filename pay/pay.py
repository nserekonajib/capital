...
class PayClass():
    ...
    # Collections Subscription Key: collection subkey
    collections_subkey = "b26b85fae1f34a9bbbc7ae6d7957bf91"

    # Disbursement subscription key
    disbursements_subkey = "5af09f7e1b6e421fa910b32d8baa3923"
